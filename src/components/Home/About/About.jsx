...
const About = () => {
  ...
  return (
    ...
    <h2>
        ...
        ensuring a tasty, crispy crêpe. We are always improving our
        crêpes by taking your feedback and applying it to our food.
      </h2>
      <h2>
        We started out in 2015 testing our product on local street
        food markets in Horsham West Sussex and in Marylebone, London. From
        there we moved our crêperie into the events and festivals and have been traveling the UK from our South East
        London base.
      </h2>
      <h2>
        ...
        feedback to help others that work in this fun environment
