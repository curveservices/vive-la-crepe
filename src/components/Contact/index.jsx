    ...
    <>
      <div className="container contact-page">
        <div className="text-box">
          ...
          <p>
            If you are interested in our services for you special day, party or
            event please contact us. We are dedicatted to making you special
            event memorable. However, if you have any other requuests or
            questions, please do not hesitate to contact us using the form below
          </p>
